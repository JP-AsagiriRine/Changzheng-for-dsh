...
| Branding | Top-left `logo.png` at 112px, centered and pasted directly (no frame); click = New Session; hero shows a 128px radiating star + 256px "为人民服�? banner (original "探索未至之境 · 预览�? headline hidden) |
...
| Tips dialog | Shows "1.兵贵神�?/ 2.欲速则不达 / 3.人心齐，泰山�?; close by clicking the mask or the button |
| Icon usage | `star.png` �?workspace folder icons; `settings.png` �?settings entry; `new.png` �?New Session action; `新分�?png` �?fork action; `read.png` �?read-type tool cards and the permission control; `write.png` �?write/edit cards; `thinking/complete/error.png` �?running/done/error tool states |
...
| Actions | Sidebar-footer "New Session" (new.png) and session-header "Fork" (新分�?png) are functional |
| Status text | "深度求索�?.." is displayed as "为人民服务中..." (same red gradient shimmer) |
...
| V1.2 | Code blocks / user messages black-red right angles, themed tool cards / thinking / context-injection rows, enhanced CRT, new "为人民服�? banner |
